...
export default function LubriskinLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f3ee] text-stone-800">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-2 md:items-center md:px-10 lg:px-12 lg:py-24">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="#productos"
                className="rounded-2xl bg-stone-900 px-6 py-3 text-sm font-semibold text-white shadow-xl transition hover:-translate-y-0.5"
              >
                Explorar línea
              </a>
              <a
                href="#texturas"
                className="rounded-2xl border border-stone-300 bg-white/85 px-6 py-3 text-sm font-semibold text-stone-800 shadow-sm transition hover:-translate-y-0.5"
              >
              ...
              <div className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
                <div className="rounded-[28px] bg-[linear-gradient(180deg,#efe7dd_0%,#f7f3ed_100%)] p-5 shadow-inner">
                  <div className="overflow-hidden h-full min-h-[280px] rounded-[24px] bg-white/70 shadow-sm">
                    <img
                      src="data:image/webp;base64,"
                      alt="Moodboard visual Lubriskin"
                ...
                <div className="flex flex-col justify-between rounded-[28px] bg-[#fcfaf7] p-6">
                  <div>
                    ...
                    <div className="mt-3 text-3xl font-semibold leading-tight text-stone-900">
                      La crema que se siente cercana, pero se ve impecable.
                    </div>
                    <p className="mt-4 text-base leading-8 text-stone-600">
                      Pensada para personas que buscan confianza, suavidad y una decisión de compra clara, sin complicaciones ni promesas exageradas.
                    </p>
                  </div>
                  <div className="mt-6 rounded-[24px] border border-stone-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-2 text-base font-medium leading-7 text-stone-800">
                      Neutros cálidos, acentos suaves, piel real, texturas cremosas y una sensación limpia y cuidada.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-18 md:px-10 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-stone-900 md:text-4xl">
              Una página premium también se construye con fotos que transmiten textura, suavidad y confianza.
            </h2>
            <p className="mt-4 text-lg leading-8 text-stone-600">
              Agregué una sección especial para que la página incluya imágenes como las del manual: crema extendida, acercamientos sensoriales y escenas limpias de rutina diaria.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-18 md:px-10 lg:px-12">
          <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight text-stone-900 md:text-4xl">
                Una estética más refinada sin perder claridad, funcionalidad y cercanía.
              </h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[28px] border border-stone-200 bg-white/90 p-6 shadow-sm">
                ...
                <p className="mt-3 text-sm leading-7 text-stone-600">
                  Mensajes claros y visuales limpios que transmiten cuidado real, no promesas exageradas.
                </p>
              </div>
              <div className="rounded-[28px] border border-stone-200 bg-white/90 p-6 shadow-sm">
                ...
                <p className="mt-3 text-sm leading-7 text-stone-600">
                  Pensada para usuarios pragmáticos que valoran calidad, claridad y recompra.
                </p>
              </div>
              <div className="rounded-[28px] border border-stone-200 bg-white/90 p-6 shadow-sm sm:col-span-2">
                ...
                <p className="mt-3 text-base leading-8 text-stone-700">
                  Usa fotos con mármol claro, toallas neutras, manos aplicando crema, macro shots de textura y empaques bien iluminados en tonos oat cream, warm taupe, dusty lavender y soft teal.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-18 md:px-10 lg:px-12" id="respaldo">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
                La credibilidad también forma parte de la experiencia premium.
              </h2>
        ...
        <div className="mx-auto max-w-7xl px-6 py-18 md:px-10 lg:px-12">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight text-stone-900 md:text-4xl">
                Lubriskin: la crema que siempre está en casa, ahora con una presencia digital más elevada.
              </h2>
              <p className="mt-4 text-lg leading-8 text-stone-600">
                Esta versión ya está pensada para verse más premium y ahora combina tus fotos reales de producto con imágenes editoriales tomadas del manual, incluyendo textura, aplicación en piel y recursos visuales lifestyle para elevar más la experiencia.
              </p>
            </div>
            <div className="rounded-[30px] border border-stone-200 bg-white p-8 shadow-[0_14px_45px_rgba(63,41,24,0.08)]">
              ...
              <p className="mt-4 text-base leading-8 text-stone-600">
                Puedo seguirla puliendo con botón de WhatsApp, datos del laboratorio y una sección final para distribuidores o cadenas de autoservicio.
              </p>
